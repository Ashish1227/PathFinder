...
trek_data = pd.read_csv('/home/tejdeep/Documents/Sem8/RecSys/flask/archive/Treks_data.csv')
user_features = pd.read_csv('/home/tejdeep/Documents/Sem8/RecSys/flask/archive/user_features.csv')
user_ratings = pd.read_csv('/home/tejdeep/Documents/Sem8/RecSys/flask/archive/user_trek_ratings.csv')
...
class ContextualBandit:
    def __init__(self, user_features, trail_features, user_ratings, epsilon, alpha):
        ...
        self.alpha = alpha
        self.data_file = 'bandit_eg_data.csv'
        self.weights_file = 'bandit_eg_weights.txt'
        self.data = []
        self.temp_data = []
